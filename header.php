...
.main-footer{
   ...
   <!-- 
       <p style="color: black;margin-top: 10px;text-align: center;display: block; margin: auto;"><b style="font-size: 25px;">SISTEM INFORMASI LAPORAN KEUANGAN </b></p> -->
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:#708090;">
                <!-- Brand Logo -->
                <a href="<?= ('dashboard'); ?>" class="brand-link navbar-white text-center" style="background-color: #BC8F8F; ">
